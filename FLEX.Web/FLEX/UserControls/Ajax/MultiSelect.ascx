            ...
            <ContentTemplate>
               <div class="panel panel-primary"> 
                  <div class="panel-heading">
                       ...
                       <span class="badge pull-right"><asp:Label id="lbCountDataLeft" runat="server"></asp:label></span>
                       <div class="input-group  pull-right">
                          <asp:TextBox ID="txtApplyLeft" runat="server"  ForeColor="Black"/> <asp:LinkButton runat="server" ID="btnApplyLeft" CssClass="btn btn-default btn-xs" ToolTip="Apply" Text="✓" OnClick="btnApplyLeft_Click"/> <asp:LinkButton runat="server" ID="lkbtnClearLeft" CssClass="btn btn-default btn-xs" ToolTip="Clear" OnClick="btnClearLeft_Click"><span class="glyphicon glyphicon-trash padded-icon"></span></asp:LinkButton>
                        </div>
                  </div>
            ...
            <ContentTemplate>
               <div class="panel panel-primary">
                  <div class="panel-heading">
                     ...
                     <span class="badge pull-right"><asp:Label id="lbCountDataRight" runat="server"></asp:label></span>
                     <div class="input-group  pull-right">
                         <asp:TextBox ID="txtApplyRight" runat="server" ForeColor="Black" /> <asp:LinkButton runat="server" ID="btnApplyRight" CssClass="btn btn-default btn-xs" ToolTip="Apply" Text="✓" OnClick="btnApplyRight_Click"/><asp:LinkButton runat="server" ID="lkbtnClearRight" CssClass="btn btn-default btn-xs" ToolTip="Clear" OnClick="btnClearRight_Click"><span class="glyphicon glyphicon-trash padded-icon"></span></asp:LinkButton>
                     </div>
                   </div>
                  <div class="workingArea">
                        <!-- Custom content, like a grid view -->
