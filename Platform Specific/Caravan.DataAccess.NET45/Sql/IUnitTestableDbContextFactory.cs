...
{
    /// <summary>
    ///   Interfaccia che descrive una factory per i contesti dedicata allo unit testing.
    /// </summary>
        ...
        where TContext : UnitTestableDbContext<TContext>, new()
    {
        ...
        ///   richiamato nel SetUp di ogni test al fine di garantire una situazione pulita sul database.
        /// </summary>
        void Reset();
    }
}
