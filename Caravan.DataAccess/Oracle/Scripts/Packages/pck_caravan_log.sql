...
CREATE OR REPLACE PACKAGE mydb.pck_caravan_log AS
   ...
   procedure sp_log_debug         (p_application           in nvarchar2,
                                   p_user                  in nvarchar2,
   ...
   procedure sp_log_info          (p_application           in nvarchar2,
                                   p_user                  in nvarchar2,
                                   p_code_unit             in nvarchar2,
                                   p_function              in nvarchar2,
                                   p_short_msg             in nvarchar2,
   ...
   procedure sp_log_warn          (p_application           in nvarchar2,
                                   p_user                  in nvarchar2,
                                   p_code_unit             in nvarchar2,
                                   p_function              in nvarchar2,
                                   p_short_msg             in nvarchar2,
   ...
   procedure sp_log_error         (p_application           in nvarchar2,
                                   p_user                  in nvarchar2,
                                   p_code_unit             in nvarchar2,
                                   p_function              in nvarchar2,
                                   p_short_msg             in nvarchar2,
   ...
   procedure sp_log_fatal         (p_application           in nvarchar2,
                                   p_user                  in nvarchar2,
                                   p_code_unit             in nvarchar2,
                                   p_function              in nvarchar2,
                                   p_short_msg             in nvarchar2,
