...
(
   ...
   , CONSTRAINT fk_crvnsecusrgrp_crvnsecusr FOREIGN KEY (cusr_id, cusr_app_id) REFERENCES userbase.caravan_sec_user (cusr_id, capp_id) ON DELETE CASCADE ENABLE
   , CONSTRAINT fk_crvnsecusrgrp_crvnsecgrp FOREIGN KEY (cgrp_id, cgrp_app_id) REFERENCES userbase.caravan_sec_group (cgrp_id, capp_id) ON DELETE CASCADE ENABLE
