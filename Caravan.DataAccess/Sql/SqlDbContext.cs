...
namespace Finsa.Caravan.DataAccess.Sql
{
    internal sealed class SqlDbContext : DbContextBase
    {
        ...
        protected override void OnModelCreating(DbModelBuilder mb)
        {
            ...
            mb.Entity<SecApp>().ToTable("CARAVAN_SEC_APP", Settings.Default.DefaultSqlSchema);
            ...
            mb.Entity<SecUser>().ToTable("CARAVAN_SEC_USER", Settings.Default.DefaultSqlSchema);
            ...
            mb.Entity<SecGroup>().ToTable("CARAVAN_SEC_GROUP", Settings.Default.DefaultSqlSchema);
            ...
            mb.Entity<SecGroup>()
               ...
               .WithMany(x => x.Groups)
               .Map(x => x.MapLeftKey("CGRP_ID", "CGRP_APP_ID").MapRightKey("CUSR_ID", "CUSR_APP_ID").ToTable("CARAVAN_SEC_USER_GROUP", Settings.Default.DefaultSqlSchema));

            /************************************************
             * SecContext
             ************************************************/

            mb.Entity<SecContext>().ToTable("CARAVAN_SEC_CONTEXT", Settings.Default.DefaultSqlSchema);
            ...
            mb.Entity<SecObject>().ToTable("CARAVAN_SEC_OBJECT", Settings.Default.DefaultSqlSchema);
            ...
            mb.Entity<SecEntry>().ToTable("CARAVAN_SECURITY", Settings.Default.DefaultSqlSchema);
            ...
            mb.Entity<LogSetting>().ToTable("CARAVAN_LOG_SETTINGS", Settings.Default.DefaultSqlSchema);
            ...
            mb.Entity<LogEntry>().ToTable("CARAVAN_LOG", Settings.Default.DefaultSqlSchema);
