...
namespace Finsa.Caravan.DataAccess.Sql
{
    internal sealed class SqlDbContext : DbContextBase
    {
        ...
        protected override void OnModelCreating(DbModelBuilder mb)
        {
            ...
            mb.Entity<SecApp>().ToTable("CARAVAN_SEC_APP", Settings.Default.SqlSchema);
            ...
            mb.Entity<SecUser>().ToTable("CARAVAN_SEC_USER", Settings.Default.SqlSchema);
            ...
            mb.Entity<SecGroup>().ToTable("CARAVAN_SEC_GROUP", Settings.Default.SqlSchema);
            ...
            mb.Entity<SecContext>().ToTable("CARAVAN_SEC_CONTEXT", Settings.Default.SqlSchema);
            ...
            mb.Entity<SecObject>().ToTable("CARAVAN_SEC_OBJECT", Settings.Default.SqlSchema);
            ...
            mb.Entity<SecEntry>().ToTable("CARAVAN_SECURITY", Settings.Default.SqlSchema);
            ...
            mb.Entity<LogSetting>().ToTable("CARAVAN_LOG_SETTINGS", Settings.Default.SqlSchema);
            ...
            mb.Entity<LogEntry>().ToTable("CARAVAN_LOG", Settings.Default.SqlSchema);
