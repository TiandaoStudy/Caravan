...
(
   ...
   , CONSTRAINT pk_caravan_sec_group PRIMARY KEY (cgrp_id, capp_id) USING INDEX _index ENABLE
   , CONSTRAINT uk_caravan_sec_group UNIQUE (cgrp_name, capp_id) USING INDEX _index ENABLE
