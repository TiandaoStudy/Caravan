...
(
   ...
   , CONSTRAINT pk_caravan_sec_user PRIMARY KEY (cusr_id, capp_id) USING INDEX _index ENABLE
   , CONSTRAINT uk_caravan_sec_user UNIQUE (cusr_login, capp_id) USING INDEX _index ENABLE
