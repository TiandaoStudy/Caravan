...
namespace FLEX.Extensions.TestDataAccess
{
    public sealed partial class Candidate
    {
        ...
        {
            var sql = new StringBuilder("select c.Cand_Id, c.Cand_Name, c.Cand_Surname, c.Cand_Email, s.Schl_Description, g.Gend_Description from Candidate c, School s, CandidateAttended ca, Gender g where c.Cand_Id = ca.Cand_Id and s.Schl_Id = ca.Schl_Id and c.Gend_Id = g.Gend_Id ");
            // Gender
