<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MultipleFileUpload.ascx.cs"
            Inherits="Finsa.Caravan.WebForms.UserControls.MultipleFileUpload" %>

<asp:Panel ID="pnlParent" runat="server" Width="300px" BorderColor="Black" BorderWidth="1px" BorderStyle="Solid">
   ...
   <asp:Panel ID="pnlButton" runat="server" Width="300px" HorizontalAlign="Right">
      ...
      <asp:Button ID="btnUpload" OnClientClick=" javascript:return DisableTop(); " runat="server" Text="Upload" Width="60px" OnClick="btnUpload_Click" />

      <asp:Label ID="lblCaption" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small" ForeColor="Gray"></asp:Label>&nbsp;
   </asp:Panel>
