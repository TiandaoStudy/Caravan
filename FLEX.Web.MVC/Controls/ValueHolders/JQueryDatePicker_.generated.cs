...
namespace FLEX.Web.MVC.Controls.ValueHolders
{
    ...
    public static class JQueryDatePicker_
    {

public static System.Web.WebPages.HelperResult JQueryDatePicker(this HtmlHelper htmlHelper, JQueryDatePickerOptions options) {
