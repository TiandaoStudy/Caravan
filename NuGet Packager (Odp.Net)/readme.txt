Configuration Sections for Entity Framework
===========================================

Use this if and only if you have already installed the Entity Framework package (or, at least, if you are going to do it):
